...
export default function QRGenerator() {
  ...
  return (
    <section style={{ background: "var(--bg-card)", border: "1px solid var(--linea)", borderRadius: 16, padding: 20 }}>
      <h2 className="sec-title" style={{ fontSize: 18, marginBottom: 16 }}>
        Generar código QR
      </h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start">
        <div className="flex-1">
          ...
          />
          <div className="mt-4">
            <p className="text-xs font-semibold uppercase tracking-wide mb-2" style={{ color: "var(--gris)" }}>
              Descargar como
            </p>
            <div className="flex gap-3">
              <button
                onClick={downloadPng}
                style={{ background: "var(--verde)", color: "#020D18" }}
        ...
        <div
          ...
          style={{ background: "#fff", border: "2px solid var(--oro)" }}
        >
          <QRCodeSVG
